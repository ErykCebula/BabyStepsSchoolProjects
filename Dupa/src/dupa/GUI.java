 ...
 * @author Producer
 */
public class GUI extends javax.swing.JFrame implements OnClear, OnAdd {
    ...
    private void printBtnMouseClicked(java.awt.event.MouseEvent evt) {                                      
        for(int number = 0; number<controller.size(); number++) {
            System.out.println(controller.getItem(number));
        }
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {                                          
         controller.addItem(item.getText());
    ...
    @Override
    public void addedItem(String newItem) {
        list.append(newItem+"\n");
         item.setText("");
    }
